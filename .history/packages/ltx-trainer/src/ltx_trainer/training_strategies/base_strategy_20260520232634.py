...
class TrainingStrategyConfigBase(BaseModel):
    ...
    name: Literal["text_to_video", "video_to_video", "multi_reference"] = Field(
...
class ModelInputs:
    ...
    # No-reference state for identity guidance (multi-reference training)
    # When set, requires a separate transformer forward pass without references
    noref_video: Modality | None = None
