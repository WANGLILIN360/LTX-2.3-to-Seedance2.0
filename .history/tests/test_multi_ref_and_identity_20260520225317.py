...
class TestGuidedDenoiseNoref:
    ...
    def _import_denoiser(self):
        ...
        # We need ltx_core on path already (set at top of file)
        mod = importlib.util.module_from_spec(spec)
        # Patch the broken import in blocks.py by pre-loading needed items
        sys.modules["ltx_pipelines.utils.blocks"] = type(sys)("ltx_pipelines.utils.blocks")
